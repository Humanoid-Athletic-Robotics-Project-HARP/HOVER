...
from hw_wrappers.booster_k1 import BoosterK1  # noqa — activates robot registry
from inference_env.deployment_player import DeploymentPlayer
from inference_env.neural_wbc_env_cfg_real_k1 import NeuralWBCEnvCfgRealK1
from inference_env.utils import get_player_args

from neural_wbc.data import get_data_path

parser = get_player_args(description="Deployment player for running HOVER policy on Booster K1.")
...
def main():
    ...
    env_cfg = NeuralWBCEnvCfgRealK1(model_xml_path=get_data_path("mujoco/models/scene_k1.xml"))
    ...
    print("Deploying policy on Booster K1.")
